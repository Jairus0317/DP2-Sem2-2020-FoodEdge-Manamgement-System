        ...
        <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 mb-0 mb-md-0">
                    ...
                    <p><span class="font-weight-bold mr-2">Email</span></p>
                    <p><a href="mailto:foodedgecatering@gmail.com">foodedgecatering@gmail.com</a></p>
                    <p><span class="font-weight-bold mr-2">Phone</span></p>
                    <p><a href="tel:+6082428353">082 428 353</a></p>
                ...
                <div class="col-lg-7 col-md-12 mb-4 mb-md-0 py-3 shadow border">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-info btn-sm ml-0">Submit<i class="fa fa-paper-plane ml-2"></i></button>
                    </div>
