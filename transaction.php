    ...
    <div id="receipt">
        ...
        <div class="row trans">
            <div class="col">
                ...
                <a class="btn btn-outline-dark text-center btn_trans" href="" onclick="window.print()">Print This</a>
                <a class="btn btn-outline-dark text-center btn_trans" href="index.html">Back to homepage</a>
